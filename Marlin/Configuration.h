...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  31.10
    #define DEFAULT_Ki   4.29
    #define DEFAULT_Kd  56.30
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 77.6
  #define DEFAULT_bedKi 14.37
  #define DEFAULT_bedKd 279.3
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 136.8 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -8, -3.61 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 26, 26, 26, 26 } // (mm) Left, Front, Right, Back insets
